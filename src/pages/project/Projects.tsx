  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text: string, record:ProjectModel) => (
        <NavLink
          to="/projDetail"
          style={{ color: "#2684ff", textDecoration: "underline" }}
          className="table-link"
          onClick={() => handleSetProject(record)}
        >
          {text}
        </NavLink>
      ),
      ...
      <div className="table-mobile">
        <div className="list-info">
          <ul>
            ...
            <li>
              <span>Project name: </span> <span>Demo Project 113</span>
            </li>
            <li>
              <span>Category: </span> <span>Dự án web</span>
            </li>
            <li>
              <span>Creator: </span> <span>Naru</span>
            </li>
            <li>
              <span>Creator: </span> <span>123</span>
            </li>
            <li>
              <span>Action: </span>
              <div className="action">
                <a href="user-update.html" className="btn-2 btn edit">
                  <i className="fa-regular fa-pen-to-square"></i>
                </a>{" "}
                                    ...
                                    onClick={async () => {
                                      try {
                                        ...
                                        if (
                                          ...
                                          const newProject = {...project, members: newProjectMembers} as ProjectModel;
